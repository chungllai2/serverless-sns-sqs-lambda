...
describe("Test Serverless SNS SQS Lambda", function () {
    ...
    describe("when all parameters are provided", function () {
        ...
        it("should produce valid SQS FIFO with disbaled contentBasedDeduplication CF template items", function () {
            var template = { Resources: {} };
            var testConfig = {
                name: "some-name",
                topicArn: "arn:aws:sns:us-east-2:123456789012:MyTopic",
        ...
        it("should produce valid SQS FIFO with self-define lambda role CF template items", function () {
            var template = { Resources: {} };
            var testConfig = {
                name: "some-name",
                topicArn: "arn:aws:sns:us-east-2:123456789012:MyTopic",
        ...
        it("should produce valid SQS FIFO with self-define lambda role without DLQ CF template items", function () {
            var template = { Resources: {} };
            var testConfig = {
                name: "some-name",
                topicArn: "arn:aws:sns:us-east-2:123456789012:MyTopic",
        ...
        it("should produce valid SQS FIFO without DLQ CF template items", function () {
            var template = { Resources: {} };
            var testConfig = {
                name: "some-name",
                topicArn: "arn:aws:sns:us-east-2:123456789012:MyTopic",
